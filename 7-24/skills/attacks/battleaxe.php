    ...
    <div class="collapse mx-auto" id="collapseHelixstrike" data-parent="#attack-sword">
      <div class="card bg-light">
        ...
        <div class="card-body pad-5">
          <p class="card-text text-center">Gain momentum by spinning in place before slamming your battleaxe into your opponent.<br>Double Critical Hit Chance.<br>DMG = Weapon ATT + Player ATT.<br>Costs 6 Mana.</p>
        </div>
