...
<div class="container pad-10">
  ...
  <div class="col-4">
  <div class="card text-white bg-red mb-2" style="max-width: 18rem;">
    <div class="accordion" id="accordion-fist">
      ...
      <div id="collapseThree" class="collapse hidden" aria-labelledby="headingThree" data-parent="#accordion-fist">
       <div class="card-body text-center">
              <p class="card-text text-center">Slam your fist into your opponent. <br>DMG = Weapon ATT + Player ATT</p>
            </div>
      ...
      <div class="card-header pad-5 text-center">
        <button class="btn btn-link text-white text-decoration-none" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
            <h6>Chi Burst <span class="badge badge-light text-teal">3</span></h6>
        </button>
      </div>
      <div id="collapseFour" class="collapse hidden" aria-labelledby="headingFour" data-parent="#accordion-fist">
        <div class="card-body text-center">
          <p class="card-text text-center">Launch a metaphysical attack. <br> Ignores all enemy RES. <br>DMG = Weapon ATT + Player INT. <br>Costs 3 Mana.<br>
          </div>
          <ul class="list-group text-center">
            <li class="list-group-item align-items-center bg-red" style="padding: .35rem 1.25rem;">
          ...
          <ul class="list-group text-center">
            <li class="list-group-item align-items-center bg-red" style="padding: .35rem 1.25rem;">
              Enemy RES = <span class="badge badge-light text-blue">0</span>
            </li>
          </ul>
      </div>
  </div>   
  ...
  <div class="col-4">
  <div class="card text-white bg-red mb-2" style="max-width: 18rem;">
    <div class="accordion" id="accordion-staff">
      <div class="card-header text-center">
        <h4>Bo Staff</h4>
      </div>
      <div class="card-header pad-5 text-center">
      ...
      <div id="collapseFive" class="collapse hidden" aria-labelledby="headingFive" data-parent="#accordion-staff">
      <div class="card-body text-center">
              <p class="card-text text-center">Strike your opponent. <br>Critical Hits apply Stun debuff. <br>DMG = Weapon ATT + Player ATT.</p>
      </div>
            <ul class="list-group text-center">
              <li class="list-group-item align-items-center bg-red" style="padding: .35rem 1.25rem;">
                <span class="badge badge-light text-orange">3</span>
    ...
    <div id="collapseSix" class="collapse hidden" aria-labelledby="headingSix" data-parent="#accordion-staff">
      <div class="card-body text-center">
        <p class="card-text text-center">Stun an enemy for one turn. <br>DMG = Weapon ATT + Player ATT. <br>Costs 2 Mana.</p>
      </div>
        <ul class="list-group text-center">
          <li class="list-group-item align-items-center bg-red" style="padding: .35rem 1.25rem;">
            <span class="badge badge-light text-orange">1</span>
            Weapon ATT
          </li>
        </ul>
  ...
  <div class="card text-white bg-red mb-2" style="max-width: 18rem;">
    <div class="accordion" id="accordion-windfu">
      ...
      <div id="collapseOne" class="collapse hidden" aria-labelledby="headingOne" data-parent="#accordion-windfu">
       <div class="card-body text-center">
      ...
      <div class="card-header pad-5 text-center">
        <button class="btn btn-link text-white text-decoration-none" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
            <h6>Air Blast <span class="badge badge-light text-teal">3</span></h6>
        </button>
    </div>
      <div id="collapseTwo" class="collapse hidden" aria-labelledby="headingTwo" data-parent="#accordion-windfu">
       <div class="card-body text-center">
          <p class="card-text text-center">Fire hurricane-level winds from the palm of your hand. <br> Triple Critical Hit Chance. <br>DMG = Weapon ATT + Player INT.<br>Costs 3 Mana.</p>
        </div>
        <ul class="list-group text-center">
          <li class="list-group-item align-items-center bg-red" style="padding: .35rem 1.25rem;">
            <span class="badge badge-light text-orange">2</span>
