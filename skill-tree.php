...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=devsword-width, initial-scale=1, shrink-to-fit=no">
...
<div id="skill-select" class="y-flex-container pad-b-10">
  ...
  <div id="rpg-skills-lvl-10" class="border-top pad-20" style="width: 100%;">
    ...
    <?php include 'skills/ultimates-sword.php'; ?>
  ...
  <div id="rpg-skills-lvl-9" class="border-top pad-20" style="width: 100%;">
    ...
    <?php include 'skills/attacks-sword.php'; ?>
  ...
  <div id="rpg-skills-lvl-8" class="border-top pad-20" style="width: 100%;">
    ...
    <?php include 'skills/supports-sword.php'; ?>
