  ...
  <div id="passive-defense2" class="row mx-auto pad-10">
    ...
    <div class="collapse mx-auto" id="collapseDEFboost2" data-parent="#passive-defense2">
      <div class="card bg-light">
        ...
        <div class="card-body pad-5">
          <p class="card-text text-center">Permanently increase DEF and HP by an additional 1.<br>
        </div>
    ...
    <div class="collapse mx-auto" id="collapseRESboost2" data-parent="#passive-defense2">
      <div class="card bg-light">
        ...
        <div class="card-body pad-5">
          <p class="card-text text-center">Permanently increase RES and HP by an additional 1.<br>
        </div>
        <ul class="list-group list-group-flush text-center">
          <li class="list-group-item bg-light align-items-center" style="padding: .35rem 1.25rem;">
            <span class="badge bg-white text-red">+1</span>
