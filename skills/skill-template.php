<div class="row">
  ...
  <div class="accordion" id="accordion-Salve">
      ...
      <div id="collapseTwo" class="collapse hidden" aria-labelledby="headingTwo" data-parent="#accordion-Salve">
        <div class="card-body light-transparency pad-10 text-center">
          <p class="card-text text-center">Heal any ally. <br>HEAL = Weapon ATT. <br>Costs 2 Mana.</p>
