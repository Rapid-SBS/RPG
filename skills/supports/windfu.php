  ...
  <div id="support-windfu" class="row mx-auto pad-10">
    ...
    <div class="collapse mx-auto" id="collapseLevitate" data-parent="#support-windfu">
      <div class="card bg-light">
        ...
        <div class="card-body pad-5">
          <p class="card-text text-center">Use your mastery of the wind to float in the<br> air, allowing you to attack from a vantage point.<br>Boosts INT for 1 turn.<br>Costs 6 Mana.</p>
        </div>
