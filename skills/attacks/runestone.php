  ...
  <div id="attack-runestone" class="row mx-auto pad-10">
    ...
    <div class="collapse mx-auto" id="collapseSteamshot" data-parent="#attack-runestone">
      <div class="card bg-light">
        ...
        <div class="card-body pad-5">
          <p class="card-text text-center">Combine ice and fire elements to form an<br>extremely high-pressure burst of steam.<br>DMG = 2 x (Player INT).<br> Costs 5 Mana.</p>
        </div>
