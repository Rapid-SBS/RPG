  ...
  <div id="ultimate-windfu" class="row mx-auto pad-10">
    ...
    <div class="collapse mx-auto" id="collapseAircannon" data-parent="#ultimate-windfu">
      <div class="card bg-light">
        ...
        <div class="card-body pad-5">
          <p class="card-text text-center">Fire a blast of extreme air pressure<br>so intense it can shatter boulders.<br>Double Critical Hit Rate.<br>DMG = 3 x (Player INT).<br> Costs 10 Mana.</p> 
        </div>
    ...
    <div class="collapse mx-auto" id="collapseHurricanesphere" data-parent="#ultimate-windfu">
      <div class="card bg-light">
        ...
        <div class="card-body pad-5">
          <p class="card-text text-center">Trap your enemies in a giant sphere and<br>bombard them with hurricane-force winds.<br> DMG = 2 x (Player INT).<br> Costs 12 Mana.</p>
        </div>
      </div><!-- /.card -->
    </div><!-- /.collapse -->
