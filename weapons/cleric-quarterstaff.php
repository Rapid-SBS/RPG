  <!-- Quarterstaff -->
  <div class="rpg-wpn-quarterstaff card wide-275 mar-20 text-white bg-yellow">
  <div class="accordion" id="accordion-quarterstaff">
      ...
      <div id="collapseThree" class="collapse hidden" aria-labelledby="headingThree" data-parent="#accordion-quarterstaff">
      ...
      <div id="collapseFour" class="collapse hidden" aria-labelledby="headingFour" data-parent="#accordion-quarterstaff">
        <div class="card-body light-transparency pad-10 text-center">
