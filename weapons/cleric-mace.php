 ...
 <div class="rpg-wpn-mace card wide-275 mar-20 text-white bg-yellow">
  <div class="accordion" id="accordion-mace">
      ...
      <div id="collapseOne" class="collapse hidden" aria-labelledby="headingOne" data-parent="#accordion-mace">
      ...
      <div id="collapseTwo" class="collapse hidden" aria-labelledby="headingTwo" data-parent="#accordion-mace">
        <div class="card-body light-transparency pad-10 text-center">
