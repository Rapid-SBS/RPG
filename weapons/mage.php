 ...
 <div class="card wide-275 mar-20 text-white bg-blue">
  <div class="accordion" id="accordion-ice">
      ...
      <div id="collapseTwo" class="collapse hidden" aria-labelledby="headingTwo" data-parent="#accordion-ice">
        <div class="card-body light-transparency pad-10 text-center">
          <p class="card-text text-center">Summon a protective wall of ice. <br> Grants the user or a single ally bonus DEF and RES for one turn. <br>Costs 3 Mana.</p>
        </div>
        <ul class="list-group text-center">
          <li class="list-group-item align-items-center light-transparency bg-blue" style="padding: .35rem 1.25rem;">
  ...
  <div class="accordion" id="accordion-fire">
      ...
      <div id="collapseThree" class="collapse hidden" aria-labelledby="headingThree" data-parent="#accordion-fire">
        <div class="card-body light-transparency pad-10 text-center">
      ...
      <div id="collapseFour" class="collapse hidden" aria-labelledby="headingFour" data-parent="#accordion-fire">
        <div class="card-body light-transparency pad-10 text-center">
  ...
  <div class="accordion" id="accordion-lightning">
      ...
      <div id="collapseFive" class="collapse hidden" aria-labelledby="headingThree" data-parent="#accordion-lightning">
        <div class="card-body light-transparency pad-10 text-center">
      ...
      <div class="card-header pad-5 text-center">
        <button class="btn btn-link text-white text-decoration-none" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
          <h6>Thunder Storm <span class="badge badge-light text-teal">3</span></h6>
        </button>
      </div>
